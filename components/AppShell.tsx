...
import { period, entities } from "@/lib/data";
  ...
  return (
    <div className="min-h-screen bg-ink-50 text-ink-800">
      ...
      <div className="lg:hidden sticky top-0 z-40 flex h-14 items-center justify-between border-b border-ink-200 bg-white/90 backdrop-blur px-3">
        ...
        <button className="btn btn-ghost -mr-1.5" aria-label="Search">
      ...
      <div className="flex">
        ...
        >
          ...
          <div className="px-3 py-3 border-b border-ink-100">
            <div className="rounded-lg bg-ink-50 ring-1 ring-ink-200/70 px-3 py-2.5">
          ...
          <div className="px-3 mt-4">
            ...
            <div className="space-y-0.5">
              {entities.map((e) => (
                <div
                  key={e.id}
                  className="flex items-center gap-2 rounded-md px-2 py-1.5 text-xs text-ink-600 hover:bg-ink-50"
                >
                  <span
                    className={[
                      "dot",
          ...
          <div className="absolute bottom-0 left-0 right-0 border-t border-ink-100 px-3 py-3 bg-white">
            <div className="flex items-center gap-2.5">
              ...
              <button className="btn btn-ghost -mr-1.5" aria-label="Settings">
...
function PeriodPill() {
  return (
    <button className="inline-flex items-center gap-1.5 rounded-lg ring-1 ring-ink-200 bg-white px-2.5 py-1.5 text-xs font-medium text-ink-700 hover:bg-ink-50">
