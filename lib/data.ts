...
// Trial balances per entity (each entity has a distinct ledger set + figures
// tailored to its operations). All in INR thousands ('000), at functional
// currency. Foreign-currency entities are shown post-translation for demo.
const tbParent: LedgerLine[] = [
  { code: "1001", ledger: "Cash on Hand", debit: 8400, credit: 0, fsGroup: "Cash & Cash Equivalents" },
  { code: "1002", ledger: "HDFC Bank — Operating A/c 1142", debit: 384200, credit: 0, fsGroup: "Cash & Cash Equivalents" },
  { code: "1003", ledger: "Axis Bank — Treasury Sweep", debit: 240000, credit: 0, fsGroup: "Bank Balances Other" },
  { code: "1101", ledger: "Trade Receivables — Domestic", debit: 1842000, credit: 0, fsGroup: "Trade Receivables" },
  { code: "1102", ledger: "Trade Receivables — Acme Logistics (IC)", debit: 24800, credit: 0, fsGroup: "Trade Receivables (IC)", note: "Inter-company" },
  { code: "1103", ledger: "ECL Provision — Trade Receivables", debit: 0, credit: 64200, fsGroup: "Trade Receivables", note: "Ind AS 109 ECL" },
  { code: "1201", ledger: "Inventory — Raw Material", debit: 412800, credit: 0, fsGroup: "Inventories" },
  { code: "1202", ledger: "Inventory — WIP", debit: 184200, credit: 0, fsGroup: "Inventories" },
  { code: "1203", ledger: "Inventory — Finished Goods", debit: 227200, credit: 0, fsGroup: "Inventories" },
  { code: "1301", ledger: "Land & Buildings", debit: 4842000, credit: 0, fsGroup: "Property, Plant & Equipment" },
  { code: "1302", ledger: "Plant & Machinery", debit: 5284000, credit: 0, fsGroup: "Property, Plant & Equipment" },
  { code: "1303", ledger: "Acc Depn — PPE", debit: 0, credit: 1880000, fsGroup: "Property, Plant & Equipment" },
  { code: "1401", ledger: "ROU Asset — Head Office Lease", debit: 612400, credit: 0, fsGroup: "Right-of-Use Assets", note: "Ind AS 116" },
  { code: "1501", ledger: "Investment in Acme Tech (100%)", debit: 250000, credit: 0, fsGroup: "Investment in Subsidiaries" },
  { code: "1502", ledger: "Investment in Acme Logistics (75%)", debit: 380000, credit: 0, fsGroup: "Investment in Subsidiaries" },
  { code: "1503", ledger: "Investment in Acme SG (100%)", debit: 184200, credit: 0, fsGroup: "Investment in Subsidiaries" },
  { code: "1504", ledger: "Investment in Acme Renewables (60%)", debit: 84200, credit: 0, fsGroup: "Investment in Subsidiaries" },
  { code: "1505", ledger: "Investment in Northstar (51%)", debit: 349600, credit: 0, fsGroup: "Investment in Subsidiaries", note: "Acquired May-24" },
  { code: "2001", ledger: "Trade Payables — Domestic", debit: 0, credit: 1284000, fsGroup: "Trade Payables" },
  { code: "2002", ledger: "Trade Payables — Acme Tech (IC)", debit: 0, credit: 14800, fsGroup: "Trade Payables (IC)", note: "Inter-company" },
  { code: "2101", ledger: "Term Loan — HDFC", debit: 0, credit: 1842000, fsGroup: "Borrowings — Non-current" },
  { code: "2102", ledger: "Working Capital Loan — SBI", debit: 0, credit: 612400, fsGroup: "Borrowings — Current" },
  { code: "2201", ledger: "Lease Liability — Non-current", debit: 0, credit: 484200, fsGroup: "Lease Liabilities — Non-current" },
  { code: "2202", ledger: "Lease Liability — Current", debit: 0, credit: 128200, fsGroup: "Lease Liabilities — Current" },
  { code: "2301", ledger: "Deferred Tax Liability", debit: 0, credit: 184200, fsGroup: "Deferred Tax Liabilities" },
  { code: "2401", ledger: "Provision — Gratuity", debit: 0, credit: 84200, fsGroup: "Provisions", note: "Ind AS 19" },
  { code: "3001", ledger: "Equity Share Capital — Face Value ₹10", debit: 0, credit: 250000, fsGroup: "Equity Share Capital" },
  { code: "3002", ledger: "Securities Premium", debit: 0, credit: 1842000, fsGroup: "Other Equity" },
  { code: "3003", ledger: "Retained Earnings", debit: 0, credit: 5094900, fsGroup: "Other Equity" },
  { code: "4001", ledger: "Revenue — Industrial Products", debit: 0, credit: 8425000, fsGroup: "Revenue from Operations" },
  { code: "4002", ledger: "Revenue — Acme Logistics (IC)", debit: 0, credit: 64500, fsGroup: "Revenue (IC)", note: "Inter-company" },
  { code: "4101", ledger: "Other Income — Dividend from Acme Tech", debit: 0, credit: 32000, fsGroup: "Other Income", note: "Inter-company" },
  { code: "5001", ledger: "Cost of Materials Consumed", debit: 3284000, credit: 0, fsGroup: "Cost of Materials Consumed" },
  { code: "5101", ledger: "Employee Benefits Expense", debit: 1248000, credit: 0, fsGroup: "Employee Benefits Expense" },
  { code: "5201", ledger: "Finance Costs — Interest", debit: 218400, credit: 0, fsGroup: "Finance Costs" },
  { code: "5301", ledger: "Depreciation & Amortisation", debit: 384200, credit: 0, fsGroup: "Depreciation & Amortisation" },
  { code: "5401", ledger: "Other Expenses", debit: 1842000, credit: 0, fsGroup: "Other Expenses" },
];

const tbTech: LedgerLine[] = [
  { code: "1001", ledger: "Cash on Hand", debit: 240, credit: 0, fsGroup: "Cash & Cash Equivalents" },
  { code: "1002", ledger: "ICICI Bank — Current A/c 4421", debit: 184200, credit: 0, fsGroup: "Cash & Cash Equivalents" },
  { code: "1101", ledger: "Trade Receivables — SaaS Subscriptions", debit: 286400, credit: 0, fsGroup: "Trade Receivables" },
  { code: "1102", ledger: "Contract Asset — Unbilled Revenue", debit: 84200, credit: 0, fsGroup: "Other Current Assets", note: "Ind AS 115" },
  { code: "1103", ledger: "ECL Provision — Trade Receivables", debit: 0, credit: 8400, fsGroup: "Trade Receivables", note: "Ind AS 109 ECL" },
  { code: "1201", ledger: "Capitalised Software Development", debit: 124800, credit: 0, fsGroup: "Other Intangible Assets", note: "Ind AS 38" },
  { code: "1202", ledger: "Acc Amort — Software", debit: 0, credit: 28400, fsGroup: "Other Intangible Assets" },
  { code: "1301", ledger: "Computers & Servers", debit: 412800, credit: 0, fsGroup: "Property, Plant & Equipment" },
  { code: "1302", ledger: "Acc Depn — Computers", debit: 0, credit: 184200, fsGroup: "Property, Plant & Equipment" },
  { code: "1401", ledger: "ROU Asset — Office Lease", debit: 84200, credit: 0, fsGroup: "Right-of-Use Assets", note: "Ind AS 116" },
  { code: "2001", ledger: "Trade Payables — Cloud Vendors", debit: 0, credit: 184200, fsGroup: "Trade Payables" },
  { code: "2002", ledger: "Payables — Acme Logistics (IC)", debit: 0, credit: 38200, fsGroup: "Trade Payables (IC)", note: "Inter-company" },
  { code: "2101", ledger: "Lease Liability — Non-current", debit: 0, credit: 64200, fsGroup: "Lease Liabilities — Non-current" },
  { code: "2102", ledger: "Lease Liability — Current", debit: 0, credit: 20000, fsGroup: "Lease Liabilities — Current" },
  { code: "2201", ledger: "Deferred Revenue — Annual Subs", debit: 0, credit: 142800, fsGroup: "Other Current Liabilities", note: "Ind AS 115" },
  { code: "2301", ledger: "Deferred Tax Liability", debit: 0, credit: 24800, fsGroup: "Deferred Tax Liabilities" },
  { code: "3001", ledger: "Equity Share Capital", debit: 0, credit: 50000, fsGroup: "Equity Share Capital" },
  { code: "3002", ledger: "Retained Earnings", debit: 0, credit: 200000, fsGroup: "Other Equity" },
  { code: "4001", ledger: "Revenue — SaaS Subscriptions", debit: 0, credit: 1422000, fsGroup: "Revenue from Operations" },
  { code: "4002", ledger: "Revenue — Acme Parent (IC)", debit: 0, credit: 14800, fsGroup: "Revenue (IC)", note: "Inter-company" },
  { code: "4003", ledger: "Revenue — Acme Logistics (IC)", debit: 0, credit: 38200, fsGroup: "Revenue (IC)", note: "Inter-company" },
  { code: "4004", ledger: "Implementation Services", debit: 0, credit: 367000, fsGroup: "Revenue from Operations" },
  { code: "4101", ledger: "Interest Income", debit: 0, credit: 12400, fsGroup: "Other Income" },
  { code: "5001", ledger: "Cloud Hosting & Infrastructure", debit: 412600, credit: 0, fsGroup: "Other Expenses" },
  { code: "5101", ledger: "Employee Benefits — Engineering", debit: 486200, credit: 0, fsGroup: "Employee Benefits Expense" },
  { code: "5201", ledger: "Finance Costs", debit: 24600, credit: 0, fsGroup: "Finance Costs" },
  { code: "5202", ledger: "Current Tax Expense", debit: 250960, credit: 0, fsGroup: "Tax Expense" },
  { code: "5301", ledger: "Depreciation & Amortisation", debit: 68400, credit: 0, fsGroup: "Depreciation & Amortisation" },
  { code: "5401", ledger: "Marketing & Customer Acquisition", debit: 380000, credit: 0, fsGroup: "Other Expenses" },
];

const tbSG: LedgerLine[] = [
  { code: "1001", ledger: "Cash — DBS SGD A/c (translated)", debit: 184200, credit: 0, fsGroup: "Cash & Cash Equivalents", note: "FX @ 65.4 closing" },
  { code: "1002", ledger: "Bank Balances Other (FCY)", debit: 18400, credit: 0, fsGroup: "Bank Balances Other" },
  { code: "1101", ledger: "Trade Receivables — Asia Pacific", debit: 184200, credit: 0, fsGroup: "Trade Receivables" },
  { code: "1102", ledger: "ECL Provision — TR (FCY)", debit: 0, credit: 6200, fsGroup: "Trade Receivables", note: "Ind AS 109 ECL" },
  { code: "1201", ledger: "Inventory — Stock-in-Transit", debit: 84200, credit: 0, fsGroup: "Inventories" },
  { code: "1301", ledger: "Office Equipment", debit: 184200, credit: 0, fsGroup: "Property, Plant & Equipment" },
  { code: "1302", ledger: "Acc Depn — Office Equipment", debit: 0, credit: 38400, fsGroup: "Property, Plant & Equipment" },
  { code: "1401", ledger: "ROU Asset — Marina One Office", debit: 64200, credit: 0, fsGroup: "Right-of-Use Assets", note: "Ind AS 116" },
  { code: "2001", ledger: "Trade Payables — APAC Vendors", debit: 0, credit: 124200, fsGroup: "Trade Payables" },
  { code: "2002", ledger: "Payables — Acme Parent (IC)", debit: 0, credit: 78400, fsGroup: "Trade Payables (IC)", note: "Inter-company · GR/IR pending" },
  { code: "2101", ledger: "Lease Liability — Non-current", debit: 0, credit: 48400, fsGroup: "Lease Liabilities — Non-current" },
  { code: "2102", ledger: "Lease Liability — Current", debit: 0, credit: 15800, fsGroup: "Lease Liabilities — Current" },
  { code: "2201", ledger: "Borrowings — Local SGD Loan", debit: 0, credit: 184200, fsGroup: "Borrowings — Non-current" },
  { code: "2301", ledger: "Deferred Tax Liability", debit: 0, credit: 18400, fsGroup: "Deferred Tax Liabilities" },
  { code: "3001", ledger: "Equity Share Capital (SGD translated)", debit: 0, credit: 65400, fsGroup: "Equity Share Capital" },
  { code: "3002", ledger: "Foreign Currency Translation Reserve", debit: 0, credit: 21800, fsGroup: "Other Equity", note: "FCTR · OCI" },
  { code: "3003", ledger: "Retained Earnings", debit: 0, credit: 3600, fsGroup: "Other Equity" },
  { code: "4001", ledger: "Revenue — APAC Sales", debit: 0, credit: 612400, fsGroup: "Revenue from Operations" },
  { code: "4101", ledger: "FX Gain (Realised)", debit: 0, credit: 8400, fsGroup: "Other Income" },
  { code: "5001", ledger: "Cost of Goods Sold", debit: 284200, credit: 0, fsGroup: "Cost of Materials Consumed" },
  { code: "5101", ledger: "Employee Benefits Expense", debit: 94800, credit: 0, fsGroup: "Employee Benefits Expense" },
  { code: "5201", ledger: "Finance Costs", debit: 18200, credit: 0, fsGroup: "Finance Costs" },
  { code: "5301", ledger: "Depreciation & Amortisation", debit: 24800, credit: 0, fsGroup: "Depreciation & Amortisation" },
  { code: "5401", ledger: "Other Expenses", debit: 84200, credit: 0, fsGroup: "Other Expenses" },
];

const tbRenew: LedgerLine[] = [
  { code: "1001", ledger: "Cash & Bank — Renewables Project A/c", debit: 28400, credit: 0, fsGroup: "Cash & Cash Equivalents" },
  { code: "1101", ledger: "Trade Receivables — DISCOM", debit: 64200, credit: 0, fsGroup: "Trade Receivables" },
  { code: "1102", ledger: "Subsidy Receivable — MNRE", debit: 24800, credit: 0, fsGroup: "Other Current Assets", note: "Ind AS 20 grant" },
  { code: "1201", ledger: "Solar Panel Inventory (in transit)", debit: 24800, credit: 0, fsGroup: "Inventories" },
  { code: "1301", ledger: "Solar Plant & Equipment", debit: 286400, credit: 0, fsGroup: "Property, Plant & Equipment" },
  { code: "1302", ledger: "Acc Depn — Solar Plant", debit: 0, credit: 42800, fsGroup: "Property, Plant & Equipment" },
  { code: "1303", ledger: "Capital Work in Progress — 12 MW Plant", debit: 84200, credit: 0, fsGroup: "Property, Plant & Equipment", note: "CWIP" },
  { code: "1401", ledger: "ROU Asset — Land Lease 25 yrs", debit: 12400, credit: 0, fsGroup: "Right-of-Use Assets" },
  { code: "2001", ledger: "Trade Payables — EPC Contractors", debit: 0, credit: 38400, fsGroup: "Trade Payables" },
  { code: "2101", ledger: "Borrowings — IREDA Term Loan", debit: 0, credit: 142800, fsGroup: "Borrowings — Non-current" },
  { code: "2102", ledger: "Borrowings — Working Capital", debit: 0, credit: 28400, fsGroup: "Borrowings — Current" },
  { code: "2201", ledger: "Decommissioning Provision", debit: 0, credit: 4200, fsGroup: "Provisions", note: "Ind AS 37" },
  { code: "2301", ledger: "Deferred Tax Liability", debit: 0, credit: 6200, fsGroup: "Deferred Tax Liabilities" },
  { code: "3001", ledger: "Equity Share Capital", debit: 0, credit: 100000, fsGroup: "Equity Share Capital" },
  { code: "3002", ledger: "Retained Earnings", debit: 0, credit: 135900, fsGroup: "Other Equity" },
  { code: "4001", ledger: "Revenue — Energy Sales (PPA)", debit: 0, credit: 184200, fsGroup: "Revenue from Operations" },
  { code: "4101", ledger: "Capital Subsidy — Income", debit: 0, credit: 2100, fsGroup: "Other Income", note: "Ind AS 20" },
  { code: "5001", ledger: "O&M — Solar Plant", debit: 86400, credit: 0, fsGroup: "Other Expenses" },
  { code: "5101", ledger: "Employee Benefits Expense", debit: 28400, credit: 0, fsGroup: "Employee Benefits Expense" },
  { code: "5201", ledger: "Finance Costs", debit: 8400, credit: 0, fsGroup: "Finance Costs" },
  { code: "5301", ledger: "Depreciation & Amortisation", debit: 14200, credit: 0, fsGroup: "Depreciation & Amortisation" },
  { code: "5401", ledger: "Other Expenses", debit: 22400, credit: 0, fsGroup: "Other Expenses" },
];

const tbNorth: LedgerLine[] = [
  { code: "1001", ledger: "Cash & Bank — USD A/c (translated)", debit: 42100, credit: 0, fsGroup: "Cash & Cash Equivalents", note: "FX @ 84.2 closing" },
  { code: "1101", ledger: "Trade Receivables — US Customers", debit: 84200, credit: 0, fsGroup: "Trade Receivables" },
  { code: "1102", ledger: "Trade Receivables — Acme Parent (IC)", debit: 14200, credit: 0, fsGroup: "Trade Receivables (IC)", note: "Inter-company · ECL Ind AS 109" },
  { code: "1201", ledger: "Inventory — Components", debit: 18400, credit: 0, fsGroup: "Inventories" },
  { code: "1301", ledger: "Property, Plant & Equipment", debit: 124800, credit: 0, fsGroup: "Property, Plant & Equipment" },
  { code: "1302", ledger: "Customer Relationships (PPA)", debit: 24000, credit: 0, fsGroup: "Other Intangible Assets", note: "Ind AS 103 PPA · 7-yr life", flagged: true },
  { code: "1303", ledger: "Brand (PPA)", debit: 11000, credit: 0, fsGroup: "Other Intangible Assets", note: "Ind AS 103 PPA" },
  { code: "1401", ledger: "ROU Asset — US Office Lease", debit: 18200, credit: 0, fsGroup: "Right-of-Use Assets" },
  { code: "2001", ledger: "Trade Payables — US Vendors", debit: 0, credit: 24200, fsGroup: "Trade Payables" },
  { code: "2101", ledger: "Borrowings — USD Loan (translated)", debit: 0, credit: 84200, fsGroup: "Borrowings — Non-current" },
  { code: "2201", ledger: "Lease Liability — Non-current", debit: 0, credit: 14200, fsGroup: "Lease Liabilities — Non-current" },
  { code: "2202", ledger: "Lease Liability — Current", debit: 0, credit: 4000, fsGroup: "Lease Liabilities — Current" },
  { code: "2301", ledger: "Deferred Tax Liability (incl. PPA DTL)", debit: 0, credit: 8400, fsGroup: "Deferred Tax Liabilities", note: "DTL on FV uplift" },
  { code: "3001", ledger: "Equity Share Capital (USD translated)", debit: 0, credit: 84200, fsGroup: "Equity Share Capital" },
  { code: "3002", ledger: "FCTR — USD Translation", debit: 0, credit: 1400, fsGroup: "Other Equity", note: "OCI · CTR" },
  { code: "3003", ledger: "Retained Earnings (post-acquisition)", debit: 0, credit: 78500, fsGroup: "Other Equity" },
  { code: "4001", ledger: "Revenue — North America Sales", debit: 0, credit: 246800, fsGroup: "Revenue from Operations" },
  { code: "4002", ledger: "Revenue — Acme Parent (IC)", debit: 0, credit: 14200, fsGroup: "Revenue (IC)", note: "Inter-company" },
  { code: "4101", ledger: "Other Income", debit: 0, credit: 4800, fsGroup: "Other Income" },
  { code: "5001", ledger: "Cost of Materials Consumed", debit: 94200, credit: 0, fsGroup: "Cost of Materials Consumed" },
  { code: "5101", ledger: "Employee Benefits Expense", debit: 64200, credit: 0, fsGroup: "Employee Benefits Expense" },
  { code: "5201", ledger: "Finance Costs (incl. acq financing)", debit: 12800, credit: 0, fsGroup: "Finance Costs" },
  { code: "5301", ledger: "Depreciation & Amortisation", debit: 18400, credit: 0, fsGroup: "Depreciation & Amortisation" },
  { code: "5401", ledger: "Other Expenses", debit: 38400, credit: 0, fsGroup: "Other Expenses" },
];
...
export const tbLogi: LedgerLine[] = [
  ...
  { code: "3102", ledger: "Retained Earnings", debit: 0, credit: 46350, fsGroup: "Other Equity" },
...
export const tbByEntity: Record<string, LedgerLine[]> = {
  parent: tbParent,
  tech: tbTech,
  logi: tbLogi,
  sg: tbSG,
